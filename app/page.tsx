...
export const metadata: Metadata = {
  ...
  description:
    "Download 400+ professionally designed templates for PowerPoint, Google Slides, Excel, Word, and Google Docs. Free to browse, instant download. Premium downloads just $1.",
  alternates: {
