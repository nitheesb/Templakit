...
function getFiltered(tab: TabKey) {
  switch (tab) {
    ...
    case "free":     return templates.filter(t => !t.isPro).slice(0, 6)
  ...
  return (
    <section className="border-t border-border/40">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        {/* Tabs */}
        <div className="mt-8 flex gap-1 rounded-xl border border-border bg-secondary/30 p-1 w-fit">
