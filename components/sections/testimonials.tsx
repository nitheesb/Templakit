...
const testimonials = [
  {
    ...
    quote: "Templakit completely transformed how we create marketing materials. The PowerPoint and Google Slides templates are stunning — we save 10+ hours every week.",
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    quote: "As a designer I'm extremely picky about templates. Templakit's Excel models are genuinely world-class. My clients always ask who designed their decks.",
    rating: 5,
  },
  {
    name: "James Park",
